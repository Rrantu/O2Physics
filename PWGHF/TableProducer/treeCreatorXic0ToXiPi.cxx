...
DECLARE_SOA_TABLE(HfKfXicFulls, "AOD", "HFKFXICFULL",
                  ...
                  full::TpcNSigmaPiFromLambda, full::TpcNSigmaPrFromLambda,
...
struct HfTreeCreatorXic0ToXiPi {
  ...
  void processKfDataFull(MyEventTable const& collisions, MyTrackTable const&,
                         soa::Join<aod::HfCandToXiPi, aod::HfXicKf, aod::HfSelToXiPi> const& candidates)
  {
  ...
  PROCESS_SWITCH(HfTreeCreatorXic0ToXiPi, processKfDataFull, "Process KF data", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorXic0ToXiPi, processDataFull, "Process data with full information", true);
  ...
  PROCESS_SWITCH(HfTreeCreatorXic0ToXiPi, processMcFullXic0, "Process MC with full information for xic0", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorXic0ToXiPi, processMcFullOmegac0, "Process MC with full information for omegac0", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorXic0ToXiPi, processDataLite, "Process data and produce lite table version", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorXic0ToXiPi, processMcLiteXic0, "Process MC and produce lite table version for xic0", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorXic0ToXiPi, processMcLiteOmegac0, "Process MC and produce lite table version for omegac0", false);
...
{
  return WorkflowSpec{
    adaptAnalysisTask<HfTreeCreatorXic0ToXiPi>(cfgc)};
}
